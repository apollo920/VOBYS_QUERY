...
SELECT
    ...
    E.CNPJ                          NU_CNPJ_ORGAO,
    E.RAZAO_SOCIAL                  NO_ORGAO,
    1                               CO_PODER,      -- Executivo
    1                               CO_TIPO_PODER, -- Administração Direta
    CASE
        WHEN CF.ID_CATEGORIA_FUNCIONAL IN (
            1000061, 1000080, 1000261, 1000281, 1000060, 1000262, 1000260,
            1000440, 1000284, 1000223, 1000286, 1000287, 1000285, 1000263,
            1000421, 1000280, 1000460, 1000461, 1000380
        ) THEN 8 -- Militares (não se aplica abono)
        WHEN EXISTS (
            SELECT 1 FROM SW_CBMPI.FOLHA_FICHA_FINANCEIRA
    ...
    CASE
        ...
        WHEN CF.ID_CATEGORIA_FUNCIONAL IN (
            1000020, -- PROFESSOR 40H
            1000022, -- PROFESSOR-20H
            1000000, -- PROFESSOR SL-III
            1000360, -- PROFESSOR SE-II
            1000282, -- PROFESSOR SE-I
            1000283, -- PROFESSOR A-III
            1000302  -- ORIENTADOR EDUCACIONAL-40H
        ) THEN 2 -- Professores Educ. Infantil/Fund./Médio
        WHEN CF.ID_CATEGORIA_FUNCIONAL IN (
            1000160, -- Agente de Polícia
            1000300, -- Agente de Polícia Classe Especial
            1000342, -- Escrivão de Polícia
            1000420, -- Oficial Investigador de Polícia Especial
            1000381  -- Assistente Técnico (carreira policial)
        ) THEN 4 -- Policiais Civis (Estaduais)
        WHEN CF.ID_CATEGORIA_FUNCIONAL IN (
            1000264  -- Policial Penal
        ) THEN 5 -- Agente Penitenciário / Policial Penal
    ...
    CASE
        WHEN CF.ID_CATEGORIA_FUNCIONAL IN (
            ...
            1000440, 1000284, 1000223, 1000286, 1000287, 1000285, 1000263,
            1000421, 1000280, 1000460, 1000461, 1000380
        ) THEN 8 -- Militares em Atividade
        WHEN CF.ID_CATEGORIA_FUNCIONAL IN (
            1000020, 1000022, 1000000, 1000360, 1000282, 1000283, 1000302
        ) THEN 3 -- Critério para aposentadoria como professor
        WHEN CF.ID_CATEGORIA_FUNCIONAL IN (
            1000160, 1000300, 1000342, 1000420, 1000381, 1000264
        ) THEN 4 -- Atividade de risco (Art. 40, §4º, inc. II, CF)
        ELSE 1   -- Sem critério diferenciado
    END                             CO_CRITERIO_ELEGIBILIDADE,
    FC.COD_INSTITUCIONAL            ID_SERVIDOR_MATRICULA,
    FC.CPF_PESSOA                   ID_SERVIDOR_CPF,
    FC.PISPASEP                     ID_SERVIDOR_PIS_PASEP,
    CASE
        WHEN P.ID_SEXO = 1 THEN 'M'
        WHEN P.ID_SEXO = 2 THEN 'F'
    END                             CO_SEXO_SERVIDOR,
    CASE
    ...
    END                             CO_EST_CIVIL_SERVIDOR,
    FC.DATA_NASCIMENTO              DT_NASC_SERVIDOR,
    1                               CO_SITUACAO_FUNCIONAL, -- BUSCAR PELO PERFIL COM REMUNERAÇÃO / LICENCIADO / CADASTRO DE LICENÇA AFASTAMENTO
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_CBMPI.FOLHA_FICHA_FINANCEIRA
            WHERE
    ...
    END                             CO_TIPO_VINCULO,
    ''                              DT_ING_SERV_PUB,
    FC.DATA_ADMISSAO                DT_ING_ENTE,
    FI.DATA_EXERCICIO               DT_ING_CARREIRA,
    C.NOME_CARREIRA                 NO_CARREIRA,
    CF.DATA_CRIACAO                 DT_ING_CARGO,
    CF.NOME_CATEGORIA_FUNCIONAL     NO_CARGO,
    NVL((
        SELECT
            SUM(VALOR_CALCULADO)
        FROM
    ...
    CASE
        WHEN CF.ID_CATEGORIA_FUNCIONAL IN (
            1000061, 1000080, 1000263 -- SOLDADO / CABO / Soldado
        ) THEN P.DATA_NASCIMENTO + ( 54 * 365 )
        WHEN CF.ID_CATEGORIA_FUNCIONAL IN (
            1000260, 1000262, 1000285, -- 3 SARGENTO / 2 SARGENTO / 1º Sargento
            1000060, 1000287           -- 1 SARGENTO / SUBTENENTE
        ) THEN P.DATA_NASCIMENTO + ( 54 * 365 )
        WHEN CF.ID_CATEGORIA_FUNCIONAL IN (
            1000261, 1000281, 1000421  -- 1 TENENTE / 2 TENENTE / 1º Tenente
        ) THEN P.DATA_NASCIMENTO + ( 56 * 365 )
        WHEN CF.ID_CATEGORIA_FUNCIONAL IN (
            1000286, 1000280           -- CAPITAO / Capitão
        ) THEN P.DATA_NASCIMENTO + ( 56 * 365 )
        WHEN CF.ID_CATEGORIA_FUNCIONAL IN (
            1000223, 1000380           -- MAJOR / Major
        ) THEN P.DATA_NASCIMENTO + ( 58 * 365 )
        WHEN CF.ID_CATEGORIA_FUNCIONAL IN (
            1000284, 1000460           -- TENENTE-CORONEL / Tenente Coronel
        ) THEN P.DATA_NASCIMENTO + ( 58 * 365 )
        WHEN CF.ID_CATEGORIA_FUNCIONAL IN (
            1000440, 1000461           -- CORONEL / Coronel
        ) THEN P.DATA_NASCIMENTO + ( 59 * 365 )
        ELSE P.DATA_NASCIMENTO + ( 70 * 365 )
    END                             DT_PROV_APOSENT,
...
FROM
    ...
    LEFT JOIN SW_CBMPI.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_PGEPI.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_PGEPI.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    LEFT JOIN SW_PGEPI.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_CGEPI.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_CGEPI.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    JOIN SW_CGEPI.FUNCIONARIO_INGRESSO FI ON FI.ID_FUNCIONARIO = FC.ID_FUNCIONARIO
    LEFT JOIN SW_CGEPI.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_SSPPI.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_SSPPI.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    LEFT JOIN SW_SSPPI.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_COJUV.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_COJUV.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    LEFT JOIN SW_COJUV.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_ATIPI.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_ATIPI.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    JOIN SW_ATIPI.FUNCIONARIO_INGRESSO FI ON FI.ID_FUNCIONARIO = FC.ID_FUNCIONARIO
    LEFT JOIN SW_ATIPI.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_FAPEPI.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_FAPEPI.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    LEFT JOIN SW_FAPEPI.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_DEFCIVIL.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_DEFCIVIL.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    LEFT JOIN SW_DEFCIVIL.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_ADH.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
...
FROM
    ...
    LEFT JOIN SW_ADH.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_SEAGRO.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_SEAGRO.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    LEFT JOIN SW_SEAGRO.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_IDEPI.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_IDEPI.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    LEFT JOIN SW_IDEPI.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_SURPI.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_SURPI.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    LEFT JOIN SW_SURPI.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_SEID.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_SEID.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    LEFT JOIN SW_SEID.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_SECID.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_SECID.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    LEFT JOIN SW_SECID.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_FUPIP.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_FUPIP.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    LEFT JOIN SW_FUPIP.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_SETUR.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_SETUR.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    LEFT JOIN SW_SETUR.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_AGESPISA.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_AGESPISA.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    LEFT JOIN SW_AGESPISA.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_SETRANS.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_SETRANS.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    LEFT JOIN SW_SETRANS.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_TVANTARES.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_TVANTARES.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    LEFT JOIN SW_TVANTARES.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_VICEGOV.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_VICEGOV.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    LEFT JOIN SW_VICEGOV.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_SEINFRA.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_SEINFRA.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    LEFT JOIN SW_SEINFRA.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_CCOM.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_CCOM.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    LEFT JOIN SW_CCOM.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_FUNDESPI.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_FUNDESPI.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    JOIN SW_FUNDESPI.FUNCIONARIO_INGRESSO FI ON FI.ID_FUNCIONARIO = FC.ID_FUNCIONARIO
    LEFT JOIN SW_FUNDESPI.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_SEDET.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_SEDET.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    LEFT JOIN SW_SEDET.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_INTERPI.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_INTERPI.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    LEFT JOIN SW_INTERPI.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_JUCEPI.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_JUCEPI.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    LEFT JOIN SW_JUCEPI.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_SEMAR.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_SEMAR.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    LEFT JOIN SW_SEMAR.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_GMG.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
...
FROM
    ...
    LEFT JOIN SW_GMG.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_SEPLAN.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_SEPLAN.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    LEFT JOIN SW_SEPLAN.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_SAF.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
...
FROM
    ...
    LEFT JOIN SW_SAF.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_SECULT.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_SECULT.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    LEFT JOIN SW_SECULT.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_DER.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
...
FROM
    ...
    LEFT JOIN SW_DER.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_DETRAN.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_DETRAN.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    LEFT JOIN SW_DETRAN.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_IASPI.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_IASPI.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    LEFT JOIN SW_IASPI.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_ADAPI.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_ADAPI.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    LEFT JOIN SW_ADAPI.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_IMEPIPROD.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_IMEPIPROD.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    LEFT JOIN SW_IMEPIPROD.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_CPVCI.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_CPVCI.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    JOIN SW_CPVCI.FUNCIONARIO_INGRESSO FI ON FI.ID_FUNCIONARIO = FC.ID_FUNCIONARIO
    LEFT JOIN SW_CPVCI.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_CENDROGAS.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_CENDROGAS.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    LEFT JOIN SW_CENDROGAS.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_COFIR.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_COFIR.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    LEFT JOIN SW_COFIR.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_SEMINPER.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_SEMINPER.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    LEFT JOIN SW_SEMINPER.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_AGRESP.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_AGRESP.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    LEFT JOIN SW_AGRESP.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_CEPM.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_CEPM.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    JOIN SW_CEPM.FUNCIONARIO_INGRESSO FI ON FI.ID_FUNCIONARIO = FC.ID_FUNCIONARIO
    LEFT JOIN SW_CEPM.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_EMATER.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_EMATER.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    JOIN SW_EMATER.FUNCIONARIO_INGRESSO FI ON FI.ID_FUNCIONARIO = FC.ID_FUNCIONARIO
    LEFT JOIN SW_EMATER.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_FUESPI.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_FUESPI.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    LEFT JOIN SW_FUESPI.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_EMATERPROD.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_EMATERPROD.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    JOIN SW_EMATERPROD.FUNCIONARIO_INGRESSO FI ON FI.ID_FUNCIONARIO = FC.ID_FUNCIONARIO
    LEFT JOIN SW_EMATERPROD.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_CDTER.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_CDTER.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    LEFT JOIN SW_CDTER.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_SERES.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_SERES.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    LEFT JOIN SW_SERES.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_SECESP.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_SECESP.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    LEFT JOIN SW_SECESP.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_EMGERPI_CORESA.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_EMGERPI_CORESA.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    LEFT JOIN SW_EMGERPI_CORESA.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_FUNPREV.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
...
FROM
    ...
    LEFT JOIN SW_FUNPREV.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_FESPPI.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_FESPPI.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    LEFT JOIN SW_FESPPI.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_SIA.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
...
FROM
    ...
    LEFT JOIN SW_SIA.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_SETRE.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_SETRE.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    LEFT JOIN SW_SETRE.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_AGESPISA02.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_AGESPISA02.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    LEFT JOIN SW_AGESPISA02.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_SEGOV.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_SEGOV.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    LEFT JOIN SW_SEGOV.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_SASC.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_SASC.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    LEFT JOIN SW_SASC.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_METRO.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_METRO.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    LEFT JOIN SW_METRO.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_SADA.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_SADA.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    LEFT JOIN SW_SADA.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_SECMULHERES.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_SECMULHERES.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    LEFT JOIN SW_SECMULHERES.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_EMGERPI_EMATER.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_EMGERPI_EMATER.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    LEFT JOIN SW_EMGERPI_EMATER.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_SESAPI.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_SESAPI.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    LEFT JOIN SW_SESAPI.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_PMPI.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_PMPI.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    LEFT JOIN SW_PMPI.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_SEJUSPI.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_SEJUSPI.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    LEFT JOIN SW_SEJUSPI.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_SEFAZPI.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_SEFAZPI.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    LEFT JOIN SW_SEFAZPI.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_SEADPREVPI.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_SEADPREVPI.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    LEFT JOIN SW_SEADPREVPI.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_IMEPI.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_IMEPI.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    LEFT JOIN SW_IMEPI.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_BEP.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
...
FROM
    ...
    LEFT JOIN SW_BEP.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_EMGERPI_COMEPI.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_EMGERPI_COMEPI.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    LEFT JOIN SW_EMGERPI_COMEPI.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_EMGERPI_COMDEPI.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_EMGERPI_COMDEPI.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    LEFT JOIN SW_EMGERPI_COMDEPI.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_EMGERPI_COHAB.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_EMGERPI_COHAB.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    LEFT JOIN SW_EMGERPI_COHAB.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_EMGERPI_PRODEPI.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_EMGERPI_PRODEPI.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    LEFT JOIN SW_EMGERPI_PRODEPI.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_EMGERPI_CEASA.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_EMGERPI_CEASA.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    LEFT JOIN SW_EMGERPI_CEASA.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_EMGERPI_PIEMTUR.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_EMGERPI_PIEMTUR.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    LEFT JOIN SW_EMGERPI_PIEMTUR.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_EMGERPI_ETELPI_FUNART.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_EMGERPI_ETELPI_FUNART.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    LEFT JOIN SW_EMGERPI_ETELPI_FUNART.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_EMGERPI_CIDAPI.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_EMGERPI_CIDAPI.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    LEFT JOIN SW_EMGERPI_CIDAPI.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_SEDUC.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_SEDUC.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    LEFT JOIN SW_SEDUC.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_EMGERPI.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_EMGERPI.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    LEFT JOIN SW_EMGERPI.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
...
SELECT
    ...
    CASE
        ...
        WHEN EXISTS (
            SELECT 1 FROM SW_EMGERPI_CODIPI.FOLHA_FICHA_FINANCEIRA
            WHERE ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
              AND ID_RUBRICA = 11
        ) THEN 2 -- Servidores Ativos Iminentes (abono permanência)
        ELSE 1   -- Servidores Ativos
    ...
    CASE -- DATA DE EXERCÍCIO ANTERIOR A 1983 TIPO 3
        ...
        WHEN SUBSTR(FO.CHAVE_FOLHA, - 3) IN ( '100', '200' ) AND FP.IND_FUNCAO = 'S'
            ...
            SELECT
                ID_RUBRICA
            FROM
                SW_EMGERPI_CODIPI.FOLHA_FICHA_FINANCEIRA
            WHERE
                ID_FOLHA_FUNCIONARIO = FC.ID_FOLHA_FUNCIONARIO
                AND ID_RUBRICA = 7
        ) IS NOT NULL THEN 1
...
FROM
    ...
    LEFT JOIN SW_EMGERPI_CODIPI.FUNCIONARIO_REFERENCIA FREF ON FREF.ID_FUNCIONARIO = FC.ID_FUNCIONARIO AND FREF.DATA_TERMINO IS NULL
